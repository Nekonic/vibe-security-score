...
from ..shared.http import DynamicContext, _body_text, _login_payload, _scored_zero, _snip
...
def dynamic_rate_limiting(ctx: DynamicContext, cfg: Dict[str, Any]) -> CheckResult:
    ...
    try:
        ...
        return _scored_zero("rate_limiting", label, weight, f"rate limiting 프로브 예외: {exc}")


CHECKS = [
    Check("rate_limiting", "무차별 대입 방어(Rate limiting)", "dynamic", dynamic_rate_limiting),
]
